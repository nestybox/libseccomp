...
pkgdatadir = $(datadir)/libseccomp
pkgincludedir = $(includedir)/libseccomp
pkglibdir = $(libdir)/libseccomp
pkglibexecdir = $(libexecdir)/libseccomp
...
CONFIG_CLEAN_FILES = libseccomp.pc
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/configure.h.in \
	$(srcdir)/libseccomp.pc.in $(top_srcdir)/build-aux/ar-lib \
...
ACLOCAL = ${SHELL} /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_CFLAGS = -Wall
...
AR = ar
AUTOCONF = ${SHELL} /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp/build-aux/missing automake-1.16
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
VERSION_MICRO = 3
VERSION_MINOR = 4
abs_builddir = /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp
abs_srcdir = /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp
abs_top_builddir = /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp
abs_top_srcdir = /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/rmolina/wsp/12-12-2019/sysbox/lib/seccomp/build-aux/install-sh
...
libseccomp.pc: $(top_builddir)/config.status $(srcdir)/libseccomp.pc.in
...
all-am: Makefile $(DATA) configure.h
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-pdf-am install-pkgconfDATA install-ps install-ps-am \
